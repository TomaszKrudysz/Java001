...
public class JTableDefaultTableModel extends JFrame {
    public static void main(String[] args) {
        ...
        String columns[] = {"Manufacturer","Model", "Year", "Top speed"};
        String data[][] = {
                {"Ford","T","1920","40"},
        ...
        model.insertRow(1,new Object[] {"Doge","Charger","1971","200"});
        model.insertRow(model.getRowCount(),new Object[] {"Doge","Charger","1972","200"});
